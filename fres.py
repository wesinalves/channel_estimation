...
if args.mode == "test" or args.mode == "trte":
    ...
    for SNRdB in SNRdB_values:
        ...
        testInput, testOutput = training_generator.get_examples(1, data_type="test")
        # now get the actual examples:
        testInput, testOutput = training_generator.get_examples(num_test_examples, data_type="test")
    ...
    output_filename = (
        f"all_nmse_snrdb_{SNRdB}_Nr{Nr}_Nt{Nt}_numEx{numSamplesPerExample}.txt"
    )
