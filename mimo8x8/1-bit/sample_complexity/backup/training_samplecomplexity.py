...
def train_model(input_train, output_train, input_val, output_val, instance):
    ...
    matched_model.save_weights(f'models/{quantization}/sample_complexity/matched_model_weights{instance}.h5')
...
def test_model(my_model, num_test_example, instance):
    ...
    output_filename = (
        f"all_nmse_Nr{Nr}_Nt{Nt}_numEx{numSamplesPerExample}_beijing_{instance}.txt"
    )
