...
num_validation_examples = 800
num_training_examples = 2960
...
model_filepath = f"models/{bits}/model-rosslyn-conv.h5"
...
output_filename = (
    f"all_nmse_mismatched_Nr{Nr}_Nt{Nt}_numEx256_beijing.txt"
)
