...
model_filepath = "models/{}/model_dense_range10_256samples_{}.h5".format(quantization,frequency)
...
for SNRdB in SNRdB_values:
    # load datasets
    #print('Loading data...')
    mat = loadmat(f"C:\\Users\\wesin\\Documents\\Wesin\\Doutorado\\channel-estimation\\datasets\\{quantization}\\range10\\testing\\mimo8x8_{SNRdB}snr_256samples_{frequency}.mat")
...
output_filename = (
    f"all_nmse_dense_range10_256samples_-11_Nr{Nr}_Nt{Nt}_{frequency}.txt"
)
