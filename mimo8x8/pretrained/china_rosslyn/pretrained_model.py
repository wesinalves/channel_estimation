...
def test_model(bottleneck_model, top_model, num_test_example):
    ...
    output_filename = (
        f"all_nmse_pretrained_Nr{Nr}_Nt{Nt}_numEx{numSamplesPerExample}_china_rosslyn_{num_test_example}.txt"
    )
...
with open(os.path.join(logdir, "complexity50-80.txt"), 'w') as f:
