...
num_validation_examples = np.linspace(50, 300, 20, dtype='int')

#num_training_examples = [200, 250, 300, 350]
#num_training_examples = [200, 250, 300, 350, 400, 500, 600, 700, 800, 900]
num_training_examples = np.linspace(100, 800, 20, dtype='int')
...
with open(os.path.join(logdir, "complexity200-800.txt"), 'w') as f:
