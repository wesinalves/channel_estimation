...
model_filepath = "models/model_dense_nonorm_256samples_60GHz.h5"
...
for SNRdB in SNRdB_values:
    # load datasets
    #print('Loading data...')
    mat = loadmat(f"C:\\Users\\wesin\\Documents\\Wesin\\Doutorado\\channel-estimation\\datasets\\raw\\testing\\mimo8x8_{SNRdB}snr_256samples_60GHz.mat")
...
output_filename = (
    f"all_nmse_dense_nonorm_256samples_-11_Nr{Nr}_Nt{Nt}_60GHz.txt"
)
