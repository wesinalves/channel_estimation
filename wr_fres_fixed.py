...
weights_filename = "model_{}_weights_channel_estimation_china".format(1)
model_filepath = "models/model-china.h5"
...
if args.mode == "test" or args.mode == "trte" and False:
    ...
    output_filename = (
        f"all_nmse_-11_Nr{Nr}_Nt{Nt}_numEx{numSamplesPerExample}_rosslyn-conv.txt"
    )
